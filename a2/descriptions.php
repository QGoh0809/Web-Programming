	...
	<footer class="footer" id="footer">
		<div class="w-container">
			<div class="footer-flex-container">
				...
				<ul role="list">
					<li>
						<a class="footer-link" href="https://www.sites.google.com/site/anzacdouglasraymondbaker/link-to-related-material">Realted Material</a>
					</li>
					<li>
						<a class="footer-link" href="mailto:ibak6837@bigpond.net.au">Get In Touch</a>
					</li>
					<li>
						<a class="footer-link" href="postcards.php">Letters and Postcards</a>
					</li>
					<li>
						<a class="footer-link" href="description.php">Description</a>
					</li>
					<li>
